...
{
    public partial class Frm_Reporte_Tickets_PV : Form
    {
        #region "Métodos"
        ...
        private void Frm_Reporte_Tickets_PV_Load(object sender, EventArgs e)
        {
        ...
        private void Btn_reporte_Click(object sender, EventArgs e)
        {
            ...
            {
                Reportes.Frm_Rpt_Tickets_PV ORpt_tpv = new Reportes.Frm_Rpt_Tickets_PV();
                ORpt_tpv.Txt_p1.Text = Dtp_fechaemision.Text;
                ORpt_tpv.Txt_p2.Text = Convert.ToString(Cmb_PuntoVenta.SelectedValue);
                ORpt_tpv.ShowDialog();
            }
